#!/usr/bin/env python3
"""Import batch 2 UI chrome (card frames) — copy PNG + viet .meta tay, dung chung template
voi import_ui_chrome.py."""
import shutil
import uuid
...
FILES = [
    ("card_gold.png", (6, 6, 6, 6)),
    ("card_gold_selected.png", (6, 6, 6, 6)),
    ("card_gold_disabled.png", (6, 6, 6, 6)),
]
