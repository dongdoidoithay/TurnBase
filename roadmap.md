...
## 0.1. TRẠNG THÁI THỰC TẾ (cập nhật 2026-08-10 — nguồn số liệu: [object-map.md §12](object-map.md))
...
4 type, 9 VFX asset có sẵn đã phủ gần hết, thiếu thật ~2-3 archetype (Light/Wind/neutral bolt), không
phải 65. 66 enemy đa dạng hơn, cần điều tra thêm. Đã xây thật: kỹ thuật "skeletal rig" mới
